-- FUNCTION: public.view_card_tcost_computation_v2(character varying, character varying, character varying, integer, boolean)

-- DROP FUNCTION IF EXISTS public.view_card_tcost_computation_v2(character varying, character varying, character varying, integer, boolean);

CREATE OR REPLACE FUNCTION public.view_card_tcost_computation_v2(
...
BEGIN
    ...
    IF p_for_ecar THEN
		FOR v_TCost_Computation IN (SELECT * FROM mf_transfer_cost_dl
									WHERE status_id   = 'A' 
									AND   proj_id       = p_proj_id
									AND  tcostdtl_id IN ('254','260','256','263','268','261','264','267','255','265','266',
														 '259','258','257','262','095', '215', '216', '098','034','229','166')
...
ALTER FUNCTION public.view_card_tcost_computation_v2(character varying, character varying, character varying, integer, boolean)
    OWNER TO postgres;

GRANT EXECUTE ON FUNCTION public.view_card_tcost_computation_v2(character varying, character varying, character varying, integer, boolean) TO PUBLIC;

GRANT EXECUTE ON FUNCTION public.view_card_tcost_computation_v2(character varying, character varying, character varying, integer, boolean) TO employee;

GRANT EXECUTE ON FUNCTION public.view_card_tcost_computation_v2(character varying, character varying, character varying, integer, boolean) TO postgres;
