-- FOREIGN TABLE: acerhomes.view_hlid_no_em

-- DROP FOREIGN TABLE IF EXISTS acerhomes.view_hlid_no_em;

CREATE FOREIGN TABLE IF NOT EXISTS acerhomes.view_hlid_no_em(
    ...
    SERVER server17_eastmeridian_summit
...
ALTER FOREIGN TABLE acerhomes.view_hlid_no_em
    OWNER TO postgres;