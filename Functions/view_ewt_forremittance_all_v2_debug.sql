...
BEGIN
	...
	(
		...
		(
			...
			left join rf_pv_header y on y.rplf_no = x.rplf_no and y.co_id = x.co_id
			where x.status_id != 'I'
			and x.wtax_amt != 0
			and x.co_id = p_co_id
			and DATE_TRUNC('month', y.pv_date::DATE) = DATE_TRUNC('month', MAKE_DATE(p_year::INT, p_month::INT, 1))
			--AND x.rplf_no = '000103575'
