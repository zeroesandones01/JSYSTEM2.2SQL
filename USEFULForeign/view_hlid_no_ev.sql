-- FOREIGN TABLE: acerhomes.view_hlid_no_ev

-- DROP FOREIGN TABLE IF EXISTS acerhomes.view_hlid_no_ev;

CREATE FOREIGN TABLE IF NOT EXISTS acerhomes.view_hlid_no_ev(
    ...
    SERVER server23_eastwoodvilla_summit
...
ALTER FOREIGN TABLE acerhomes.view_hlid_no_ev
    OWNER TO postgres;