select T_date, description, div_id, dept_id, project_id, sub_projectid, debit, credit, sum(debit-credit) 
		...
		(
			...
			( 
				...
				-- 		 end
				-- 	)
				-- 	and (case when 'P' = 'A' then a.status_id not in ('I','D') else a.status_id = 'P' end) 
				-- 	and a.co_id = '02' 
				-- 	and b.co_id = '02'
				-- 	and b.status_id = 'A' 
				-- 	and 
					...
					(
						...
						from 
							(
								...
								where a.co_id='02'
								and (case when 'P' = 'A' then true else a.status_id = 'P' end)--//Comment by Erick 2019-06-26
						...
						--and (case when 'P' = 'A' then true else status_id = 'P' end)--//Comment by Erick 2019-06-26 	
						...
						case 
							when to_char('2024-01-01'::date,'yyyy') <= '2017' or TRUE is true
								...
								(
									(
										case 
											when c.or_date is null or to_char(c.or_date,'yy')::int >= 18 
