-- FUNCTION: public.view_ewt_forremittance_all_v2(character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying)

-- DROP FUNCTION IF EXISTS public.view_ewt_forremittance_all_v2(character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying);

CREATE OR REPLACE FUNCTION public.view_ewt_forremittance_all_v2(
...
-- 		and coalesce(c.server_id, '') = coalesce(mfp.server_id, '')
		...
		left join rf_entity_id_no cc on (case when trim(b.rplf_type_id) = '04' then (a.entity_id) else trim(bb.entity_id1) end) = cc.entity_id --adjusted to reflect tin of each entry
...
-- 		)
		...
		left join
		(
				select sum(x.tran_amt - x.vat_amt) as net_paid, y.jv_no, x.co_id  --x.entity_type_id
				from rf_liq_detail x
				inner join rf_liq_header y on y.liq_no = x.liq_no and x.co_id = y.co_id
				where x.status_id = 'A'
				group by y.jv_no, x.co_id -- x.entity_type_id
		) j on j.jv_no = g.jv_no and j.co_id = g.co_id --and j.entity_type_id = g.entity_type_id
		where 
		--coalesce(g.jv_no, '') = ''
		--and 
...
ALTER FUNCTION public.view_ewt_forremittance_all_v2(character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying)
    OWNER TO postgres;

GRANT EXECUTE ON FUNCTION public.view_ewt_forremittance_all_v2(character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying) TO PUBLIC;

GRANT EXECUTE ON FUNCTION public.view_ewt_forremittance_all_v2(character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying) TO employee;

GRANT EXECUTE ON FUNCTION public.view_ewt_forremittance_all_v2(character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying) TO postgres;
